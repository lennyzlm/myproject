...
urlpatterns = [
    ...
    url(r'js/(?P<path>.*)', 'django.views.static.serve', {'document_root': settings.MEDIA_ROOT+'/bootstrap/js'}),
    url(r'css/(?P<path>.*)', 'django.views.static.serve',
        {'document_root': settings.MEDIA_ROOT+'/bootstrap/css'}),
    url(r'images/(?P<path>.*)', 'django.views.static.serve',
        {'document_root': settings.MEDIA_ROOT + '/bootstrap/images'}),
]
